...
const { processarArquivosHtml, processarArquivosCss, processarArquivosJs, processarArquivosImagens } = require('./tarefasGulp/aplicacao'); // Importa os módulos responsáveis por processar os arquivos
...
(
    ...
    (
        series(processarArquivosHtml, processarArquivosCss, processarArquivosJs, processarArquivosImagens), // Executa as tarefas passadas como parâmetro em série
