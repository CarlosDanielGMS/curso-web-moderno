...
const { processarArquivosHtml, processarArquivosCss, processarArquivosJs, importarArquivosImagens } = require('./tarefasGulp/aplicacao'); // Importa os módulos responsáveis por processar e importar os arquivos
...
(
    ...
    (
        series(processarArquivosHtml, processarArquivosCss, processarArquivosJs, importarArquivosImagens), // Executa as tarefas passadas como parâmetro em série
